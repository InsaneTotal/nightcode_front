        ...
        {createdTables.length === 0 ? (
          ...
          <div className="space-y-3">
            {createdTables.map((table) => (
              <div
                key={table.id}
                className="flex flex-col gap-3 rounded-xl border border-yellow-500/20 bg-black/30 p-4 md:flex-row md:items-center md:justify-between"
              >
                <div>
                ...
                {table.qrToken ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 rounded-lg border border-yellow-500/30 px-4 py-2 text-sm text-yellow-300 transition hover:bg-yellow-500/10"
                  >
                    <Download size={14} />
                    Abrir URL de orden
                  </a>
                  ...
                  <button
                    type="button"
                    disabled
                    className="inline-flex items-center gap-2 rounded-lg border border-yellow-500/20 px-4 py-2 text-sm text-yellow-300/60"
                  >
                    <Download size={14} />
                    Mesa sin token, actualiza mesas
                  </button>
